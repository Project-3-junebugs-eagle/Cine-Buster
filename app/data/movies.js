...
const movies = [
  ...
  },
  {
    ...
    title: 'All About Eve',
    description:
			"Much-loved, lengthy, acerbic drama of theatre life about a young actress who insinuates her way into Broadway stage star's life.",
    price: '5.99'
  },
  {
    id: '2021',
  ...
  },
  {
    ...
    description:
			"Jerry Mulligan (Kelly), a young American G.I., lingers in Paris after World War II to study art and painting. He wants to live the life of the great painters -- in a Montmartre garret, starving for his art. When a rich, romance-minded American gallery owner (Foch) offers to support him, he agrees -- even if the bargain means joining the benefactress' entourage of lovers.",
    price: '5.99'
  },
  {
    id: '2223',
    title: 'Annie Hall',
    description:
			"Bittersweet, cerebral, stream-of-consciousness, 70s, urban romantic comedy about a New York couple's neurotic love affair.",
    price: '5.99'
  },
  {
    id: '2425',
